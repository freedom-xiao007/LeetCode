...
if __name__ == '__main__':
    ...
    assert Solution().compress(["a","a","b","b","c","c","c", "a", "a"]) == 8
    assert Solution().compress(["a","b","b","b","b","b","b","b","b","b","b","b","b"]) == 4
    assert Solution().compress(["a","a","a","b","b","a","a"]) == 6
    assert Solution().compress(["a","a","a","a","a","b"]) == 3
